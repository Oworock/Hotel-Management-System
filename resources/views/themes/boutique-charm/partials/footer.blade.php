<footer class="boutique-site-footer">
    <div class="boutique-footer-card">
        ...
        <p>{!! \App\Support\HtmlSanitizer::clean(\App\Models\Setting::getValue('global_footer', \App\Models\Setting::getValue('welcome_description', 'A personal stay with warm details and thoughtful service.'))) !!}</p>
    </div>
